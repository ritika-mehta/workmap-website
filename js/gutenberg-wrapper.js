...
( function() {
	...
	cscoGutenberg = {
		...
		init: function( e ) {
			...
			$this.content = document.querySelector( '.block-editor-editor-skeleton__content' );
		...
		initLayout: function() {
			...
			if ( 'template-canvas-fullwidth.php' === $this.getPageTemplate() ) {
				$this.wrapper.classList.add( 'sidebar-disabled' );
			} else {
		...
		changeLayout: function() {
			...
			$this.wrapper.classList.remove( 'sidebar-enabled' );
			$this.wrapper.classList.remove( 'sidebar-disabled' );

			if ( 'right' === layout || 'left' === layout ) {
				cscoGWrapper.page_layout = 'sidebar-enabled';

				$this.wrapper.classList.add( 'sidebar-enabled' );
			} else if ( 'disabled' === layout ) {
